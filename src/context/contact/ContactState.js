...
export const getContacts = async (dispatch) => {
  try {
    const res = await axios.get('http://localhost:3333/api/contacts');
...
export const addContact = async (dispatch, contact) => {
  try {
    const res = await axios.post('http://localhost:3333/api/contacts', contact);
...
export const updateContact = async (dispatch, contact) => {
  try {
    const res = await axios.put(`http://localhost:3333/api/contacts/${contact._id}`, contact);
